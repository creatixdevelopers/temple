...
RouteView.register(dashboard, 'blogs', '/blogs/', 'dashboard/blogs.html', {'title': 'Blogs'}, decorators)
RouteView.register(dashboard, 'events', '/events/', 'dashboard/events.html', {'title': 'Events'}, decorators)
RouteView.register(dashboard, 'post', {'/post/': {'uid': None}, '/post/<string:uid>/': {}}, 'dashboard/post.html', {'title': 'Blogs & Events'}, decorators)
